...
class CLIP(nn.Module):
    def __init__(self,
        ...
        print("initial", self.transformer)
    ...
    def encode_text(self, text, attention_mask):
        ...
        print("after masking transformer", self.transformer)
        # raise RuntimeError
    ...
    def forward(self, image, text, attention_mask):
        ...
        text_last_hidden_state, text_pooled_output, text_proj_last_hidden_state = self.encode_text(text, attention_mask)
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_norm=False, drop=0., attn_drop=0.,
        ...
        # changing to nn.Linear based on this : https://github.com/huggingface/pytorch-image-models/blob/70ccf00c95a2d78a166cca24ef6adbca46f47c2a/timm/layers/mlp.py#L25
        # self.mlp = nn.Linear(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop)
